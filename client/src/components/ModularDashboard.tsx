...
// Agent metadata for quick access cards
const agentMetadata: Record<
    string,
    { icon: string; color: string; description: string; shortName?: string }
> = {
    Wisdom: {
        icon: "🧠",
