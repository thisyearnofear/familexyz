                  ...
                  <Avatar className="w-10 h-10 bg-gradient-to-r from-purple-400 to-pink-400">
                    {getMemberAvatar(currentUserId) ? (
                      ...
                      <span className="text-white font-semibold">
                        {getMemberName(currentUserId).charAt(0)}
                      </span>
                    )}
                  </Avatar>
                        ...
                        return (
                          <div key={participantId} className="space-y-1">
                            <div className="flex items-center justify-between text-sm">
                              <span className="font-medium">{getMemberName(participantId)}</span>
                              <span className="text-gray-600">{progress}/{challenge.target}</span>
                            </div>
