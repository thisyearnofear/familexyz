...
export type { GDollarEnvironment } from "./environment.js";
...
export const gooddollarPlugin: Plugin = {
    name: "gooddollar",
    description:
        "GoodDollar G$ integration plugin for FamilyXYZ - Complete UBI ecosystem with streaming rewards, identity verification, and family incentives",
    actions: [
        transferGDollarAction,
        claimUBIAction,
        verifyFamilyMemberAction,
